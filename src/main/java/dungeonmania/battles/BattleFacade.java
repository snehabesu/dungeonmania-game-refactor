...
public class BattleFacade {
    ...
    public void battle(Game game, Player player, Enemy enemy) {
        ...
        if (effectivePotion != null) {
            ...
            for (BattleItem item : player.getInventory().getEntities(BattleItem.class)) { //demeter
        ...
        player.getBattleStatistics().setHealth(playerBattleStatistics.getHealth()); //demeter
        enemy.getBattleStatistics().setHealth(enemyBattleStatistics.getHealth()); //demeter
