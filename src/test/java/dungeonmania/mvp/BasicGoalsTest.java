...
public class BasicGoalsTest {
    ...
    @Test
    @Tag("13-5")
    @DisplayName("Test achieving an enemy goal")
    public void enemyGoal() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_enemy_goal", "c_enemy_goal");
    ...
    @Test
    @Tag("13-6")
    @DisplayName("Test achieving an enemy goal including a zombie spawner")
    public void enemyGoalWithZombieToastSpawner() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_enemy_goal_with_spawner", "c_enemy_goal_with_spawner");
